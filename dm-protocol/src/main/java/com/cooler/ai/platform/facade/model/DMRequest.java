...
public class DMRequest implements java.io.Serializable{
    ...
    public DMRequest(ClientInfo clientInfo, UserInfo userInfo, LocationInfo locationInfo, String queryType, String queryMessage, Map<String, String> metaData, long timestamp, String sessionId, NLUData nluData, boolean debugModel) {
