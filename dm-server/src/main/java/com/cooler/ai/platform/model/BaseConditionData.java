...
public class BaseConditionData<V> implements ConditionData<V> {
    ...
    public BaseConditionData(ConditionRule conditionRule, ConditionLogic conditionLogic, Integer paramType, String paramsName, V value, float belief, Boolean result, boolean isNecessary) {
